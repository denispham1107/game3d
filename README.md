...
Trên iOS/iPadOS, wrapper không lưu bản sao Unity `.data` vào Cache Storage và luôn khởi tạo ở DPR 1 để giảm đỉnh RAM. iPad nâng lên Retina tối đa DPR 2. iPhone dùng cấu hình thích ứng: máy chưa xác định bắt đầu ở DPR 1.5, đo độ ổn định của game thật rồi mới nâng lên DPR 2; máy yếu giảm về DPR 1.25. Nếu WebKit bị đóng đột ngột trước khi xác nhận phiên chạy ổn định, lần mở sau tự dùng DPR 1.25. Kết quả được ghi nhớ 7 ngày và tự đánh giá lại sau đó. Safari không cung cấp model iPhone chính xác nên cơ chế này dựa trên khả năng thực tế của thiết bị, không giả định bằng tên model.
